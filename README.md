...
- **Central Business District — "largest"**: read as comparative, mirroring Land Lord — the agenda goes to whoever's largest owned commercial group is the biggest on the board (among players whose group also includes at least two tiles at 2+ stories). Since every agenda now has exactly one winner, a tie for the lead breaks on cash on hand, then turn order, rather than voiding the bonus.
